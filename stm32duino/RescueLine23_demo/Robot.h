...
public:
  ...
  int ui_cam = 0;
  int ud_cam = 0;
  float p_cam = -2.0;//-1.8;//0.1;//-0.5;//-1.7;
  float p_cube_cam = -0.0001;//-0.00007;//-0.000002;  //-0.0002;
  float p_cam_line = 0.2;//0.5;//0.5;      //0.03;//-0.03;//0.02;
  float i_cam = 0;//-0.0002;//-0.0001;
  float d_cam = 0;//-0.5;//-0.05;


  float kp_line = 0;//1000;//300;//1.2;       //2.2
  float kcube_line = 0;//3;//0.000001;//0.0045;  //0.04; //0.028
  float kd_line = 0.0;       //1.0;//-1.5;
  float ki_line = 0;//0.1;//0.5;//0.00001;//0.003;//0.009;     //0.03;//2.0;//0.5;//0.012;//0.0005;//0.009;
