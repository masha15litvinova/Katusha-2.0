...
public:
  ...
  float p_cam = 0;//-2.0;//-1.8;//0.1;//-0.5;//-1.7;
  ...
  float kp_line = 40;//1000;//300;//1.2;       //2.2
  float kcube_line = 0;//3;//0.000001;//0.0045;  //0.04; //0.028
  float kd_line = 4;       //1.0;//-1.5;
  float ki_line = 0.01;//0.1;//0.5;//0.00001;//0.003;//0.009;     //0.03;//2.0;//0.5;//0.012;//0.0005;//0.009;
