...
float ACCEL_X_MIN = -6.71;
float ACCEL_X_MAX = 16.85;
float ACCEL_Y_MIN = -10.74;
float ACCEL_Y_MAX = 20.63;
float ACCEL_Z_MIN = -268.07;
float ACCEL_Z_MAX = -243.9;

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
float MAGN_X_MIN = -550.64;
float MAGN_X_MAX = 295.57;
float MAGN_Y_MIN = -2189.05;
float MAGN_Y_MAX = -1270.82;
float MAGN_Z_MIN = -2168.04;
float MAGN_Z_MAX = -1204.81;
