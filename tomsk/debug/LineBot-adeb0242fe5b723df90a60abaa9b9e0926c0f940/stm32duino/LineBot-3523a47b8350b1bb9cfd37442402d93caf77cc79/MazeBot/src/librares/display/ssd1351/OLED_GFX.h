...
class OLED_GFX : public virtual OLED_Driver {
  ...
  public:
    ...
    void print_String(uint8_t x, uint8_t y, char *text, FONT_SIZE size);
    void Display_String_5x8(uint8_t x, uint8_t y, char *text);
    void Display_String_8x16(uint8_t x, uint8_t y, char *text);
