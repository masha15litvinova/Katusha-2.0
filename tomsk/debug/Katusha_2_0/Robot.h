...
public:
  Robot();
  bool mode_endstops = 0;
  // 0 - с отъездами 1 - для выравнивания
  ...
  float kd_line = 0.4;        //0.008;//0.0015;   //0.01;     //1.0;//-1.5;
  float ki_line = 3.2;        //40;     //0.1;//0.5;//0.00001;//0.003;//0.009;     //0.03;//2.0;//0.5;//0.012;//0.0005;//0.009;
