...
float weights[6] = {0.5, 0.32, 0.23};//{0.5, 0.27, 0.23}; //0.7 0.6 0.5
...
float kp_line = 3.3;
float kd_line = -1.0;//-1.5;
float ki_line = 0.02;//0.012;//0.0005;//0.009;
    ...
    case (LINE):
      {
        ...
        err_line_sens = 0;
        for (int i = 0; i < 3; i++) {
          err_line_sens = err_line_sens + (robot.sensors[5 - i] - robot.sensors[i]) * weights[i];
        }
...
robot.ui_line = 0;
        ...
        int delta_grey = 20;
        int u_max = 70;
        //if(!((robot.sensors[0]<delta_grey)and(robot.sensors[1]<delta_grey)and(robot.sensors[2]<delta_grey)and(robot.sensors[3]<delta_grey)and(robot.sensors[4]<delta_grey)and(robot.sensors[5]<delta_grey)))
        //{
