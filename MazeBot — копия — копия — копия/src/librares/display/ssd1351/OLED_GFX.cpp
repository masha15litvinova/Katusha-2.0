...
void OLED_GFX::print_String(uint8_t x, uint8_t y, char *text, FONT_SIZE size)  {
...
void OLED_GFX::Display_String_8x16(uint8_t x, uint8_t y, char *text) {
...
void OLED_GFX::Display_String_5x8(uint8_t x, uint8_t y, char *text)  {
